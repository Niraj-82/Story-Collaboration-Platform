...
<body>
  <header class="header fade-in">
    <div class="container">
      ...
      <nav>
        <a href="index.html" <?php echo basename($_SERVER['PHP_SELF']) == 'index.html' ? 'class="active"' : ''; ?>>
          <i class="fas fa-home"></i> Home
        </a>
        <a href="dashboard.php" <?php echo basename($_SERVER['PHP_SELF']) == 'dashboard.php' ? 'class="active"' : ''; ?>>
          <i class="fas fa-tachometer-alt"></i> Dashboard
        </a>
        <a href="create_story.php" <?php echo basename($_SERVER['PHP_SELF']) == 'create_story.php' ? 'class="active"' : ''; ?>>
          <i class="fas fa-pen-fancy"></i> Create Story
        </a>
        <a href="stories.php" <?php echo basename($_SERVER['PHP_SELF']) == 'stories.php' ? 'class="active"' : ''; ?>>
